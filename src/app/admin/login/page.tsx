      ...
      <div className="max-w-md w-full">
        ...
        <div className="border border-gray-700 rounded-4xl shadow-lg p-6">
          <form action="/api/admin/login" method="POST" className="space-y-4">
            ...
            <div>
              <label htmlFor="username" className="block text-sm font-medium text-300 mb-1">
                Usuario
              </label>
              <input 
                id="username"
                ...
                className="w-full px-4 py-3 border border-gray-600 rounded-full focus:ring-2 focus:ring-[#463f3a] focus:border-[#463f3a] bg-800 placeholder-gray-400"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text--300 mb-1">
                Contraseña
              </label>
              <input 
                id="password"
